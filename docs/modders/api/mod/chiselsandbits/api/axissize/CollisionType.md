...
<span class="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang" class="external-link">Enum</a>&lt;<a href="CollisionType.html" title="enum class in mod.chiselsandbits.api.axissize">CollisionType</a>&gt;</span></div>  
...
<table class="stretched-table">
  ...
  <tr><td><code>static final net.minecraft.network.codec.StreamCodec<wbr>&lt;io.netty.buffer.ByteBuf, <a href="CollisionType.html" title="enum class in mod.chiselsandbits.api.axissize">CollisionType</a>&gt;</code></td><td><code><a href="#STREAM_CODEC" class="member-name-link">STREAM_CODEC</a></code></td><td>&nbsp;</td></tr>
  </tbody>
</table>
:::
