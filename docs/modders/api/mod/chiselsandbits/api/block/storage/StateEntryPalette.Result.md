...
<table class="stretched-table">
  ...
  <tbody>
  <tr><td><code><a href="#%3Cinit%3E(T,mod.chiselsandbits.api.block.storage.StateEntryPalette.SizeInformation)" class="member-name-link">Result</a><wbr>(<a href="#type-param-T" title="type parameter in StateEntryPalette.Result">T</a>&nbsp;value,<br> <a href="StateEntryPalette.SizeInformation.html" title="class in mod.chiselsandbits.api.block.storage">StateEntryPalette.SizeInformation</a>&nbsp;size)</code></td><td><div class="block">Creates an instance of a <code>Result</code> record class.</div><br></td></tr>
  </tbody>
</table>
:::
...
<table class="stretched-table">
  ...
  <tr><td><code><a href="#type-param-T" title="type parameter in StateEntryPalette.Result">T</a></code></td><td><code><a href="#value()" class="member-name-link">value</a>()</code></td><td><div class="block">Returns the value of the <a href="#param-value"><code>value</code></a> record component.</div><br></td></tr>
