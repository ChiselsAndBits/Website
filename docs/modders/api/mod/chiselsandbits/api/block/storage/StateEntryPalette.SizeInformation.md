...
Indicates whether some other object is "equal to" this one. The objects are equal if the other object is of the same class and if all the record components are equal. All components in this record class are compared with the <code>compare</code> method from their corresponding wrapper classes.
<dl class="notes">
<dt>Specified by:</dt>
...
Returns the value of the <a href="#param-hasChanged"><code>hasChanged</code></a> record component.
<dl class="notes">
<dt>Returns:</dt>
