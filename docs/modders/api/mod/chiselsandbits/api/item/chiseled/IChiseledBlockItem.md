...
<a href="../../placement/IPlaceable.html#getPlacementResult(net.minecraft.world.item.ItemStack,net.minecraft.world.entity.player.Player,net.minecraft.world.phys.BlockHitResult)" title="getPlacementResult(ItemStack, Player, BlockHitResult)">getPlacementResult</a>
:::::
<!-- JavaMarkContainer Depth: 1 -->
