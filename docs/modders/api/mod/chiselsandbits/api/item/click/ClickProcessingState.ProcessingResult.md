...
<table class="stretched-table">
  ...
  <tbody>
  <tr><td><code><a href="#ALLOW" class="member-name-link">ALLOW</a></code></td><td><div class="block">Continue the further processing of the interaction.</div><br></td></tr>
  <tr><td><code><a href="#DEFAULT" class="member-name-link">DEFAULT</a></code></td><td><div class="block">Continue the further processing of the interaction.</div><br></td></tr>
  <tr><td><code><a href="#DENY" class="member-name-link">DENY</a></code></td><td><div class="block">Deny the further processing of the interaction.</div><br></td></tr>
  </tbody>
</table>
:::
:::::
