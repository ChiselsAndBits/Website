...
---
<div class="type-signature"><span class="modifiers">public record </span><span class="element-name type-name-label">PluginData&lt;T&gt;</span>(<a href="PluginData.html#type-param-T" title="type parameter in PluginData">T</a>&nbsp;plugin, boolean&nbsp;isExperimental)<br/>  
...
<table class="stretched-table">
  ...
  <tbody>
  <tr><td><code><a href="#%3Cinit%3E(T,boolean)" class="member-name-link">PluginData</a><wbr>(<a href="#type-param-T" title="type parameter in PluginData">T</a>&nbsp;plugin,<br> boolean&nbsp;isExperimental)</code></td><td><div class="block">Creates an instance of a <code>PluginData</code> record class.</div><br></td></tr>
  </tbody>
</table>
:::
</section>
...
<table class="stretched-table">
  ...
  <tr><td><code>boolean</code></td><td><code><a href="#isExperimental()" class="member-name-link">isExperimental</a>()</code></td><td><div class="block">Returns the value of the <code>isExperimental</code> record component.</div><br></td></tr>
  <tr><td><code><a href="#type-param-T" title="type parameter in PluginData">T</a></code></td><td><code><a href="#plugin()" class="member-name-link">plugin</a>()</code></td><td><div class="block">Returns the value of the <code>plugin</code> record component.</div><br></td></tr>
...
<section id="<init>(T,boolean)">

:::tabs
== PluginData
<div class="horizontal-scroll">
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="element-name">PluginData</span><wbr><span class="parameters">(<a href="#type-param-T" title="type parameter in PluginData">T</a>&nbsp;plugin,
 boolean&nbsp;isExperimental)</span></div>
...
<dd><code>isExperimental</code> - the value for the <code>isExperimental</code> record component</dd>
</dl>
</div>
:::
...
== plugin
<div class="horizontal-scroll">
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="return-type"><a href="#type-param-T" title="type parameter in PluginData">T</a></span>&nbsp;<span class="element-name">plugin</span>()</div>
...
== isExperimental
<div class="horizontal-scroll">
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="return-type">boolean</span>&nbsp;<span class="element-name">isExperimental</span>()</div>
<div class="block">Returns the value of the <code>isExperimental</code> record component.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the <code>isExperimental</code> record component</dd>
</dl>
</div>
:::
