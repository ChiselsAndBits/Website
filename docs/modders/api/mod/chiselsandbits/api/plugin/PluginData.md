...
<table class="stretched-table">
  ...
  <tbody>
  <tr><td><code><a href="#%3Cinit%3E(T)" class="member-name-link">PluginData</a><wbr>(<a href="#type-param-T" title="type parameter in PluginData">T</a>&nbsp;plugin)</code></td><td><div class="block">Creates an instance of a <code>PluginData</code> record class.</div><br></td></tr>
  </tbody>
</table>
:::
...
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="element-name">PluginData</span><wbr><span class="parameters">(<a href="#type-param-T" title="type parameter in PluginData">T</a>&nbsp;plugin)</span></div>
