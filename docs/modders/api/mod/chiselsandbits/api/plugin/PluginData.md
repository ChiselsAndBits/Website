...
<table>
  ...
  <tbody>
  <tr><td><code><a href="#%3Cinit%3E(T)" class="member-name-link">PluginData</a><wbr>(<a href="PluginData.html" title="type parameter in PluginData">T</a>&nbsp;plugin)</code></td><td><div class="block">Creates an instance of a <code>PluginData</code> record class.</div><br></td></tr>
  </tbody>
</table>
:::
:::::
...
<table>
  ...
  <tr><td><code><a href="PluginData.html" title="type parameter in PluginData">T</a></code></td><td><code><a href="#plugin()" class="member-name-link">plugin</a>()</code></td><td><div class="block">Returns the value of the <code>plugin</code> record component.</div><br></td></tr>
