...
sidebar: false 
---
_Package:_ [mod.chiselsandbits.api.reloading](index)  
...
<table class="stretched-table">
  ...
  <tbody>
  <tr><td><code>void</code></td><td><code><a href="#clear()" class="member-name-link">clear</a>()</code></td><td><div class="block">Invoked when the cache needs to be cleared.</div><br></td></tr>
  </tbody>
</table>
== Instance Methods
<table class="stretched-table">
