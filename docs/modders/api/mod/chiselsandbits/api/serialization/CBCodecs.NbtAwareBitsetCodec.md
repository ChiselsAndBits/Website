...
implements com.mojang.serialization.Codec&lt;<a href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/BitSet.html" title="class or interface in java.util" class="external-link">BitSet</a>&gt;</span></div>  
...
<div class="block">Creates an instance of a <code>NbtAwareBitsetCodec</code> record class.</div>
<dl class="notes"></dl>
:::
...
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>decode</code>&nbsp;in interface&nbsp;<code>com.mojang.serialization.Decoder&lt;<a href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/BitSet.html" title="class or interface in java.util" class="external-link">BitSet</a>&gt;</code></dd>
</dl>
:::
...
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>encode</code>&nbsp;in interface&nbsp;<code>com.mojang.serialization.Encoder&lt;<a href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/BitSet.html" title="class or interface in java.util" class="external-link">BitSet</a>&gt;</code></dd>
</dl>
:::
...
<div class="block">Indicates whether some other object is "equal to" this one. The objects are equal if the other object is of the same class and if all the record components are equal. </div>
<dl class="notes">
<dt>Specified by:</dt>
