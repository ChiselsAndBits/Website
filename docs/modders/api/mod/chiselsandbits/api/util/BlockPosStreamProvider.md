...
Provides a stream of BlockPos objects within a given range which is <code>size</code> cubed in size.
 ...
 <p>
 Internally invokes <a href="BlockPosStreamProvider.html#getForRange(int,int)"><code>getForRange(int, int)</code></a>, with <code>0</code> as the min value,
...
Provides a stream of BlockPos objects within a given world object.
 ...
 Internally invokes <a href="BlockPosStreamProvider.html#getForRange(int,int,int,int,int,int)"><code>getForRange(int, int, int, int, int, int)</code></a>, with the rounded down vectors as the min and max values.</p>
<dl class="notes">
<dt>Parameters:</dt>
...
Provides a stream of BlockPos objects within a given range from the given minimal value to the given maximal value.
 <p>
 Internally this calls <a href="BlockPosStreamProvider.html#getForRange(net.minecraft.world.phys.Vec3,net.minecraft.world.phys.Vec3)"><code>getForRange(Vec3, Vec3)</code></a>, with vectors constructed from the minimal and maximal values.
