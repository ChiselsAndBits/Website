...
<div class="block">Marker interface which represents a batch mutation
 update handler, which can be used with a try-with-resources
 mechanic to control the update process of a batch mutation.</div>
...
<div class="block">Closes this resource, relinquishing any underlying resources. This method is invoked automatically on objects managed by the <code>try</code>-with-resources statement.
 ...
 <p>Note that unlike the <a href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Closeable.html#close()" title="class or interface in java.io" class="external-link"><code>close</code></a>
